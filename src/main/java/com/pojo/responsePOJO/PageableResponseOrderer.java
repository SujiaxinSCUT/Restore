...
public class PageableResponseOrderer {

    private Set<Orderer> contents = new HashSet<>();
    private Integer page;
    private Integer size;
    private Integer total_elements;
    private Integer total_pages;

    public Set<Orderer> getContents() {
        return contents;
    }

    public void setContents(Set<Orderer> contents) {
